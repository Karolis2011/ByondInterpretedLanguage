...
namespace ByondLang.ChakraCore.Hosting
{
    ...
    public struct JsContext
    {
        ...
        {
            Native.ThrowIfError(Native.JsParseScript(script, sourceContext, sourceName, out JsValue result));
            return result;
        }
        ...
        {
            Native.ThrowIfError(Native.JsParseSerializedScript(script, buffer, sourceContext, sourceName, out JsValue result));
            return result;
        }
        ...
        {
            Native.ThrowIfError(Native.JsRunScript(script, sourceContext, sourceName, out JsValue result));
            return result;
        }
        ...
        {
            Native.ThrowIfError(Native.JsRunSerializedScript(script, buffer, sourceContext, sourceName, out JsValue result));
            return result;
        }
        ...
        /// <param name="sourceName">The location the script came from.</param>
        /// <returns>The result of the script, if any.</returns>
        public static JsValue Run(JsValue script, JsSourceContext sourceContext, string sourceUrl, JsParseScriptAttributes parseAttributes)
        {
